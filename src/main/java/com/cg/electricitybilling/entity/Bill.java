...
//	public Bill(Integer cust_id, Integer consumer_no, Integer consumed_units, String bill_month, LocalDate bill_date,
//			Double amount, LocalDate due_date, Integer meter_id) {
//		super();
...
//	}
	public Bill(Integer cust_id, Integer consumer_no, Integer consumed_units, Integer currentMonth,
			LocalDate currentDate, Double amt, LocalDate dueDate, Integer meter_id) {
		super();
		this.cust_id = cust_id;
		this.consumer_no = consumer_no;
		this.consumed_units = consumed_units;
		this.bill_month=currentMonth;
		this.bill_date = currentDate;
		this.amount = amt;
	...
	public String toString() {
		return "Bill [bill_id=" + bill_id + ", cust_id=" + cust_id + ", consumer_no=" + consumer_no
